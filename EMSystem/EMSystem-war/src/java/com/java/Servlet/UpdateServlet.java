...
public class UpdateServlet extends HttpServlet {
    ...
    private static final String UPDATE_EMPLOYEE_DETAIL_BEAN_SESION_KEY
	= "updateEmp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
	    ...
	    .getAttribute(UPDATE_EMPLOYEE_DETAIL_BEAN_SESION_KEY);
        ...
        if (EmployeeBean == null) {
            ...
            try {
                ...
                request.getSession().setAttribute(UPDATE_EMPLOYEE_DETAIL_BEAN_SESION_KEY, EmployeeBean);
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(eid != null)
            {
                ...
                boolean isUpdated = EmployeeBean.updateEmployee(employee);
                ...
                if(isUpdated){
                    ...
                    request.getRequestDispatcher("updateResult.jsp").include(request, response);     
